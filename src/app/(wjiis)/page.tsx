...
export default function HomePage() {
  ...
  return (
    <>
      <DynamicSEO
        title="EJLILEJGP - European Journal of Law, Interdisciplinary Legal Ethics and Jurisprudence Governance Practices"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in law, legal ethics, jurisprudence, and governance."
        keywords={['law journal', 'legal ethics', 'jurisprudence', 'governance', 'research journal', 'academic publishing', 'EJLILEJGP', 'peer review']}
        ogImage="https://ejlilejgp.com/og-image.jpg"
        canonicalUrl="https://ejlilejgp.com"
      />
      <WebsiteSchema
        name="EJLILEJGP"
        url="https://ejlilejgp.com"
        description="A peer-reviewed international journal dedicated to publishing rigorous research in law, legal ethics, jurisprudence, and governance."
        publisher="EJLILEJGP"
      />
      <OrganizationSchema
        name="EJLILEJGP"
        url="https://ejlilejgp.com"
        logo="https://ejlilejgp.com/ejlilejgp-logo.svg"
        description="EJLILEJGP - European Journal of Law, Interdisciplinary Legal Ethics and Jurisprudence Governance Practices"
        contactPoint={{
          email: "editor@ejlilejgp.com",
      ...
      <div className="min-h-screen font-sans">
        ...
        {/* Hero Section */}
        <section className="relative border-b border-slate-200" style={{background: 'linear-gradient(135deg, #3d1426 0%, #5c2339 100%)'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-8 space-y-6">
                <div className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide uppercase" style={{background: 'rgba(255,255,255,0.15)', color: '#d4a574'}}>
                  ISSN: 3143-0287 (Online)
                </div>
                ...
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold leading-tight text-white">
                  ...
                  <span style={{color: '#d4a574'}}>Law, Interdisciplinary Legal<br className="hidden md:block" />Ethics and Jurisprudence</span>
                </h1>

                <p className="text-xl max-w-2xl leading-relaxed" style={{color: '#d8b8a8'}}>
                  A peer-reviewed international journal dedicated to publishing rigorous research in law, legal ethics, jurisprudence, and governance globally.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link
                    ...
                    style={{background: '#6b2c45'}}
                    onMouseEnter={e => (e.currentTarget.style.background='#8b3a55')}
                    onMouseLeave={e => (e.currentTarget.style.background='#6b2c45')}
                  >
                    Submit Manuscript
                ...
                <div className="grid grid-cols-3 gap-8 pt-8 max-w-lg" style={{borderTop: '1px solid rgba(255,255,255,0.2)'}}>
                  <div>
                    ...
                    <div className="text-sm font-medium" style={{color: '#d4a574'}}>Legal Articles</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">{stats.totalAuthors.toLocaleString()}+</div>
                    <div className="text-sm font-medium" style={{color: '#d4a574'}}>Global Legal Scholars</div>
                  </div>
                  <div>
                    <div className="text-3xl font-bold text-white">22+</div>
                    <div className="text-sm font-medium" style={{color: '#d4a574'}}>Indexed In</div>
                  </div>
                </div>
              </div>
        ...
        {/* Why Choose Us */}
        <section className="py-16 border-y border-slate-200" style={{background: '#faf7f4'}}>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-serif font-bold mb-4" style={{color: '#3d1426'}}>Journal Features</h2>
              <p className="text-slate-600 max-w-2xl mx-auto">
                We are committed to the highest standards of academic publishing in legal studies and governance.
              </p>
            </div>

            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
              {[
                { icon: Globe, title: 'Global Reach', desc: 'Connecting legal scholars and practitioners from over 75 countries.' },
                ...
                { icon: Target, title: 'High Visibility', desc: 'Indexed in major legal and academic databases for maximum citation.' },
                { icon: CheckCircle2, title: 'Ethical Standards', desc: 'Strict adherence to COPE guidelines for publication ethics.' }
              ].map((feature, index) => (
                <div key={index} className="bg-white rounded-lg p-6 shadow-sm" style={{border: '1px solid #d8b8a8', borderTop: '3px solid #8b3a55'}}>
                  <feature.icon className="w-8 h-8 mb-4" style={{color: '#3d1426'}} />
                  <h3 className="text-lg font-bold mb-2" style={{color: '#3d1426'}}>{feature.title}</h3>
        ...
        {/* CTA */}
        <section className="py-16 text-white" style={{background: 'linear-gradient(135deg, #3d1426 0%, #5c2339 100%)'}}>
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-serif font-bold mb-6 text-white">
              Submit Your Legal Research Today
            </h2>
            <p className="mb-8 text-lg" style={{color: '#d8b8a8'}}>
              Join our community of legal scholars and contribute to advancing law and governance globally.
            </p>
